...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String prompt = JOptionPane.showInputDialog(null, "If you find yourself having to cross a piranha-infested river, here's how to do it...");
		...
		String bod = JOptionPane.showInputDialog(null, "Enter a body part.");
		...
		String plc = JOptionPane.showInputDialog(null, "Enter a place");
