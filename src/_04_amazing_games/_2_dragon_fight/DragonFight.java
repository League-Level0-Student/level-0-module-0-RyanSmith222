...
if(dragonHealth <= 0) {dragonLost();
}
				// 11.  Pop up a message that tells us how much health the player and
				// 		dragon have left.
JOptionPane.showMessageDialog(null, "At the end of this round, you have " + playerHealth + " health remaining. The dragon has " + dragonHealth + " health remaining.");
